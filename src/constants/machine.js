export const materialtesting = [
  ...
  },
  {
    ...
    description1:
      "Izod & Charpy Test - Resistance of a metal to impacts is evaluated in terms of impact strength. A metal may possess satisfactory ductility under static loads but may fail under dynamic loads or impact.",
    description2:
  ...
  },
  {
    ...
    image:"",
    description1:
      "Micro Vickers (HV 0.1,0.2,0.3,0.5,1) – Hardness Test is defined as the resistance to indentation, and it is determined by measuring the permanent depth of the indentation.",
    description2:
  ...
  },
  {
    ...
    description2:
      "The Brinell method applies a predetermined test load to a carbide ball of fixed diameter which is held for a predetermined time period and then removed. The resulting impression is measured with a specially designed Brinell microscope or optical system across at least two diameters.",
    specifications: {
      Model: "B 3000-TSFA",
      Make: "FIE (Fuel Instruments & Engineers Pvt. Ltd.)",
      Vendor: "CANAN testing services",
  ...
  },
  {
    ...
    description1:
      "An OES can be used to identify unknown substances, measure the concentration of known substances, and study the interaction between light and matter. OES measure the light absorbed by a sample within a certain portion of the electromagnetic spectrum.",
    description2:
      "This information can be used to determine the sample's chemical composition.",
    specifications: {
  ...
  },
  {
    ...
    description1:
      "The digital microscope uses optics and a digital camera to output an image to a monitor, sometimes by means of software running on a computer.",
    description2: "",
    specifications: {
      Model: "LV150N",
  ...
  },
  {
    ...
    description1:
      "A Salt Spray Testing Chamber is used to evaluate the corrosion resistance of materials and coatings by exposing them to a saline fog environment.",
    description2: "",
    specifications: {
      Model: "CCT-1",
      Make: "Presto",
  ...
  },
  {
    ...
    description1:
      "Abrasive Cutting, Hot Mounting, Specimen Grinding & Polishing - These processes are essential for preparing samples for further analysis and testing.",
    description2: "",
    specifications: {
      "Abrasive Cutting":
  ...
  },
  {
    ...
    description1:
      "A thermal imaging camera is used to detect heat patterns and temperature changes on the surface of objects. It translates thermal energy (heat) into visible light to analyze surroundings.",
    description2: "",
    specifications: {
      Model: "TiX1000",
      Make: "Fluke",
