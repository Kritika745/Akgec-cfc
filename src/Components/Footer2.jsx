            ...
            <div className="w-auto p-8 flex items-center justify-center">
              <a href="https://www.akgec.ac.in/">
                <div className="inline-flex items-center">
                  <img
                    className="ml-2 sm:w-[8vw] w-[12vw]"
                    src={cfc}
                    alt=""
                  />
                </div>
              </a>
              {/* <a href="https://www.akgec.ac.in/"><h1 className='uppercase ml-5 font-semibold text-xl text-gray-600 hover:text-gray-700 cursor-pointer'>AJAY kumar garg engineering college</h1></a> */}
            </div>
