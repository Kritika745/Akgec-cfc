...
const Machine = () => {
  return (
    <div className='w-full pt-16 md:pt-20 bg-gray-900 text-white pb-16'>
      <div className='flex flex-row '>

        <div className='w-[30%]'>
             <img src="https://ucarecdn.com/f3c874a3-70b7-44a7-a9ef-cd8460b9ef7d/-/crop/505x649/274,86/-/preview/3000x3000/+" className='' alt="" />
        </div>
        <div className='w-[70%] px-28 flex flex-col items-center justify-center '>
            <div className='flex flex-col w-full justify-center items-center '>
            <h1 className='text-4xl font-bold m-2'> CNC Wire Cut EDM (E Merge S64)</h1>
            <hr className="w-[40%] border-t-[3px] border-yellow-300 mb-10" />
            </div>
                  <p className='text-lg text-justify'>The Wire-Cut EDM eMerge S64 is a cutting-edge precision machining solution, designed for 
      ...
      <div className='flex w-[60%] flex-col px-6 py-4 '>
